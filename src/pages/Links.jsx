...
const Links = () => {
  const socialLinks = [
    ...
    {
      platform: "Gmail",
      url: "mailto:rahulkilaparthi7@gmail.com",
  ...
  return (
    <section className="max-container">
      ...
      >
        ...
        >
          <img
            src="https://api.dicebear.com/7.x/initials/svg?seed=Rahul&backgroundColor=3b82f6"
            alt="Kilaparthi Rahul"
        ...
        >
          I'm a B.Tech Computer Science and Engineering student at Gitam University, specializing in Cybersecurity. I have experience as a Cybersecurity Intern and as a self-driven Bug Bounty Hunter, where I identify and responsibly disclose security vulnerabilities in websites to keep systems safe.
        </motion.p>
          ...
          {socialLinks.map((link) => {
            ...
            return (
              <motion.a
                ...
                className="flex items-center justify-center gap-2 p-4 bg-black/30 backdrop-blur-sm rounded-lg hover:bg-blue-500/20 transition-colors"
                variants={{
